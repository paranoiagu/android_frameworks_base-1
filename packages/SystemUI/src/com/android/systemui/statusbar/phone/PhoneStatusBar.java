...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    final private int mWeatherTempColor = 0xFFFFFFFF;
    ...
    class SettingsObserver extends UserContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.System.getUriFor(Settings.System.SHOW_FOURG))) {
                ...
                DontStressOnRecreate();
            } else if (uri.equals(Settings.System.getUriFor(Settings.System.STATUS_BAR_WEATHER_TEMP_STYLE))
                || uri.equals(Settings.System.getUriFor(Settings.System.STATUS_BAR_WEATHER_SIZE))
                || uri.equals(Settings.System.getUriFor(Settings.System.STATUS_BAR_WEATHER_FONT_STYLE))) {
                    updateTempView();
            }
            update();
        }
    ...
    private void updateWeatherTextState(WeatherController.WeatherInfo info, int color, int size, int font) {
        String temp = WeatherUtils.formatTemperature(info.temp, info.tempUnit);
    ...
    private void updateTempView() {
        if (mWeatherTempView != null) {
            ...
            updateWeatherTextState(mWeatherController.getWeatherInfo(), mWeatherTempColor, mWeatherTempSize, mWeatherTempFontStyle);
        }
    }
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mWeatherController.addCallback(new WeatherController.Callback() {
            ...
            public void onWeatherChanged(WeatherController.WeatherInfo info) {
                updateWeatherTextState(info, mWeatherTempColor, mWeatherTempSize, mWeatherTempFontStyle);
            }
        });
        updateWeatherTextState(mWeatherController.getWeatherInfo(), mWeatherTempColor,
    ...
    public void onWeatherChanged(WeatherController.WeatherInfo info) {
        SettingsObserver observer = new SettingsObserver(mHandler);
        String temp = WeatherUtils.formatTemperature(info.temp, info.tempUnit);
        if (temp == null || info.condition == null) {
            mWeatherTempView.setText(null);
           // observer.update();
        } else {
            mWeatherTempView.setText(temp);
           // observer.update();
        }
    }
